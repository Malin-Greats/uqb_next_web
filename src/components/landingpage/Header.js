        ...
        >
            ...
            <Grid container spacing={gridSpacing} sx={{ pr: 10, [theme.breakpoints.down('lg')]: { pr: 0, textAlign: 'center' } }}>
              ...
              <Grid item xs={12}>
                ...
                >
                  ...
                  >
                    Let us take care of the printing, publishing and distribution
                    of your work. Or share your already published books with
          ...
          <Grid item xs={12} md={5} sx={{ display: { xs: 'none', md: 'flex' } }}>
            <Box sx={{ width: 300, ml: -10, position: 'relative', mt: -7 }}>
              <HeaderImage src="/assets/images/landing/HeaderWrapper.png" alt="hero img" />
            </Box>
          </Grid>
